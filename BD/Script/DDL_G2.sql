...
CREATE TABLE AVALIACAOUNIDADESENAI(
idAvalicaoUnidadeSenai INT PRIMARY KEY IDENTITY NOT NULL,
idUnidadeSenai INT FOREIGN KEY REFERENCES UNIDADESENAI(idUnidadeSenai) NOT NULL,
idUsuario INT FOREIGN KEY REFERENCES USUARIO(idUsuario) NOT NULL,
mediaAvaliacaoUnidadeSenai DECIMAL(2,1) NOT NULL,
comentarioUnidadeSenai VARCHAR(256) NOT NULL,
valorMoeda INT NOT NULL
);
GO
...
idComentarioCurso INT PRIMARY KEY IDENTITY NOT NULL,
idCurso INT FOREIGN KEY REFERENCES CURSO(idCurso) NOT NULL,
idUsuario INT FOREIGN KEY REFERENCES USUARIO(idUsuario) NOT NULL,
avaliacaoComentario DECIMAL(2,1) NOT NULL,
comentarioCurso VARCHAR(256) NOT NULL
);
GO

-- REGISTRO CURSO
CREATE TABLE REGISTROCURSO(
idRegistroCurso INT PRIMARY KEY IDENTITY NOT NULL,
idCurso INT FOREIGN KEY REFERENCES CURSO(idCurso) NOT NULL,
idUsuario INT FOREIGN KEY REFERENCES USUARIO(idUsuario) NOT NULL,
);
GO
...
idCursoFavorito INT PRIMARY KEY IDENTITY NOT NULL,
idCurso INT FOREIGN KEY REFERENCES CURSO(idCurso) NOT NULL,
idUsuario INT FOREIGN KEY REFERENCES USUARIO(idUsuario) NOT NULL,
);
GO
...
--COMENTARIO DESCONTO
CREATE TABLE COMENTARIODESCONTO(
idComentarioDesconto INT PRIMARY KEY IDENTITY NOT NULL,
idDesconto INT FOREIGN KEY REFERENCES DESCONTO(idDesconto) NOT NULL,
idUsuario INT FOREIGN KEY REFERENCES USUARIO(idUsuario) NOT NULL,
avaliacaoDesconto DECIMAL(2,1) NOT NULL,
comentarioDesconto VARCHAR(256) NOT NULL
);
GO
--REGISTRO DESCONTO
CREATE TABLE REGISTRODESCONTO(
idRegistroDesconto INT PRIMARY KEY IDENTITY NOT NULL,
idDesconto INT FOREIGN KEY REFERENCES DESCONTO(idDesconto) NOT NULL,
idUsuario INT FOREIGN KEY REFERENCES USUARIO(idUsuario) NOT NULL,
);
GO
...
--DESCONTO FAVORITO
CREATE TABLE DESCONTOFAVORITO(
idDescontoFavorito INT PRIMARY KEY IDENTITY NOT NULL,
idDesconto INT FOREIGN KEY REFERENCES DESCONTO(idDesconto) NOT NULL,
idUsuario INT FOREIGN KEY REFERENCES USUARIO(idUsuario) NOT NULL,
);
GO
